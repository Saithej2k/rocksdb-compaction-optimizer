...
That is a **22.125% reduction in stalled writes**. The model includes a
40-operation setup cost when switching compaction levels, representing task
setup and iterator initialization. Pending-aware scoring starts L0 work
earlier and avoids repeatedly paying that setup cost.
